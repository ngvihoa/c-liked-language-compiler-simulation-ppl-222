...
class BKOOLParser ( Parser ):
    ...
    class Paramlist2Context(ParserRuleContext):
        ...
        def accept(self, visitor:ParseTreeVisitor):
            if hasattr( visitor, "visitParamlist2" ):
                return visitor.visitParamlist2(self)
            else:
                return visitor.visitChildren(self)
    ...
    class Body_ele_listContext(ParserRuleContext):
        ...
        def accept(self, visitor:ParseTreeVisitor):
            if hasattr( visitor, "visitBody_ele_list" ):
                return visitor.visitBody_ele_list(self)
            else:
                return visitor.visitChildren(self)
    ...
    class Body_ele_list2Context(ParserRuleContext):
        ...
        def accept(self, visitor:ParseTreeVisitor):
            if hasattr( visitor, "visitBody_ele_list2" ):
                return visitor.visitBody_ele_list2(self)
            else:
                return visitor.visitChildren(self)
    ...
    class Body_eleContext(ParserRuleContext):
        ...
        def accept(self, visitor:ParseTreeVisitor):
            if hasattr( visitor, "visitBody_ele" ):
                return visitor.visitBody_ele(self)
            else:
                return visitor.visitChildren(self)
    ...
    class Statement_kindContext(ParserRuleContext):
        ...
        def accept(self, visitor:ParseTreeVisitor):
            if hasattr( visitor, "visitStatement_kind" ):
                return visitor.visitStatement_kind(self)
            else:
                return visitor.visitChildren(self)
    ...
    class Exprlist2Context(ParserRuleContext):
        ...
        def accept(self, visitor:ParseTreeVisitor):
            if hasattr( visitor, "visitExprlist2" ):
                return visitor.visitExprlist2(self)
            else:
                return visitor.visitChildren(self)
