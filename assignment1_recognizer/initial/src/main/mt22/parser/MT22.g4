...
dimension_size_list
	: int_literal dimension_size_list2
	| int_literal
	;

dimension_size_list2
	: COMMA int_literal dimension_size_list2
	| 
	;
...
for_Statement
	: FOR LB scalar_var ASSIGN expression COMMA expression COMMA expression RB statement
	;
...
ILLEGAL_ESCAPE
	: DQUOTE STRING_SEQUENCE? ILLEGAL_C
	{
		self.text = self.text[1:]
